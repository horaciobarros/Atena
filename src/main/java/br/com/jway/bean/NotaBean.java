...
@ManagedBean
@ViewScoped
public  class NotaBean extends SpringBeanAutowiringSupport implements Serializable {

	private static final long serialVersionUID = 1L;

	protected static final Log log = LogFactory.getLog(NotaBean.class);
	...
	public void setItem(Nota item) {
		this.item = item;
	}
	public Nota getItemFilter() {
		return itemFilter;
	}
	
	public void setItemFilter(Nota itemFilter) {
