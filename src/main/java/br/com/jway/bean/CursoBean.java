...
@ManagedBean
@ViewScoped
public  class CursoBean extends SpringBeanAutowiringSupport implements Serializable {

	private static final long serialVersionUID = 1L;

	protected static final Log log = LogFactory.getLog(CursoBean.class);
	...
	private Curso item;
	private Curso itemFilter;
	
	
	public CursoBean() {
		log.info("Bean constructor called.");
		itemFilter = new Curso();
		limpaPesquisa();
			}
	...
	public void setItem(Curso item) {
		this.item = item;
	}
	public Curso getItemFilter() {
		return itemFilter;
	}
	
	public void setItemFilter(Curso itemFilter) {
