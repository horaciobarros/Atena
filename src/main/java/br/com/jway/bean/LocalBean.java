...
@ManagedBean
@ViewScoped
public  class LocalBean extends SpringBeanAutowiringSupport implements Serializable {

	private static final long serialVersionUID = 1L;

	protected static final Log log = LogFactory.getLog(LocalBean.class);
	...
	private Local item;
	private Local itemFilter;
	
	
	public LocalBean() {
		log.info("Bean constructor called.");
		itemFilter = new Local();
		limpaPesquisa();
			}
	...
	public void setItems(List<Local> items) {
		this.items = items;
	}
	
	public Local getItem() {
		return item;
	}
	
	public void setItem(Local item) {
		this.item = item;
	}
	public Local getItemFilter() {
		return itemFilter;
	}
	
	public void setItemFilter(Local itemFilter) {
