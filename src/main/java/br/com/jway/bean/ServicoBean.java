...
@ManagedBean
@ViewScoped
public  class ServicoBean extends SpringBeanAutowiringSupport implements Serializable {
	...
	private Servico item;
	private Servico itemFilter;
	
	
	public ServicoBean() {
		log.info("Bean constructor called.");
		itemFilter = new Servico();
		limpaPesquisa();
			}
	...
	public void clearItem() {
		try {
			...
			item = Servico.class.newInstance();
	...
	public void setItems(List<Servico> items) {
		this.items = items;
	}
	
	public Servico getItem() {
		return item;
	}
	
	public void setItem(Servico item) {
		this.item = item;
	}
	public Servico getItemFilter() {
		return itemFilter;
	}
	
	public void setItemFilter(Servico itemFilter) {
