...
public class ServicoConverter implements Converter, Serializable{
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			System.out.println("Convertendo Serviço");
			return object;
		} catch (Exception e) {
			e.printStackTrace();
			throw new ConverterException("N�o foi poss�vel encontrar o Serviço  de id: " + value + ". " + e.getMessage());
		}
